  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/podcasts"
          element={<Page content={<PodcastList page={1} />} />}
          exact
        />
        <Route
          path="/podcasts/page/:id"
          element={<Page content={<PodcastList />} />}
          exact
        />
        ...
        <Route
          path="/news"
          element={<Page content={<NewsList page={1} />} />}
          exact
        />
        <Route
          path="/news/page/:id"
          element={<Page content={<NewsList />} />}
          exact
        />
